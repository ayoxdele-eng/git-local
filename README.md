...
# Step 1: Navigate to the .ssh directory on the local machine

![git-term 1](https://github.com/user-attachments/assets/33cf3272-4519-45ad-a721-bdf0f7c11426)

# Step 2: Use the "ssh-keygen" command to create private and public key pair

![git-term 2](https://github.com/user-attachments/assets/ef5584ec-0b8c-4067-967e-372c94692f95)4

# Step 3: Press the "enter key" for all the prompts that follow; use "git" as your preferred name of the key file

![git-term 3](https://github.com/user-attachments/assets/68ba7ab8-792d-4d02-9283-80c89c97a860)

# Step 4: Confirm the availability of the key pair 

![git-term 4](https://github.com/user-attachments/assets/812c67ea-4389-4859-9c38-f8d4bae8fc55)

# Step 5: The "cat" command gets the public key's contents. The output of this step will be used in the step 10

![git-term 5](https://github.com/user-attachments/assets/ac029e27-2f43-4fc8-9d3a-21181e5fd117)

# Step 6: Navigate to your GitHub account settings. Click on the icon as shown in the screenshot
...
# Step 9: Click New SSH Key.

![git 4](https://github.com/user-attachments/assets/236471f0-c0ed-4050-befc-26b99f570999)

# Step 10: Paste the contents of step 5 into the "key' text area; Add a title. Click on "Add SSH key"
